...
LABEL description="INops AI Application"
LABEL version="1.0"
...
COPY apps/ai/package.json apps/ai/package-lock.json ./
...
# Copy application source from ai directory
COPY apps/ai/ ./
...
CMD ["npm", "run", "preview", "--", "--port", "3010", "--host", "0.0.0.0"]
